---
layout: post
title: "The Cost of Assupmtions: False Consensus Bias and Projection"
...
There’s a specific kind of mistake I make sometimes.
It doesn’t come from being unaware.  
It comes from assuming too much.

More specifically... assuming other people think more like me than they actually do.

Not in personality. In standards.
...
On their own, both are manageable.
...
Not missing the signal...
but refusing to let it mean what it probably meant.

---

## Integrity and the Assumption of Alignment

A lot of this comes down to the gap between words and actions.
If I say I’ll do something, I mean it.  
...
It just isn’t universally true.

For a lot of people, words are only used for presentation.
A promise might mean intention.  
...
The problem usually isn’t that the evidence wasn’t there.
It's that I didn’t want the evidence to mean what it clearly meant.
...
The awkward part is that this bias doesn’t feel like a bias.
...
But “surely” is doing a lot of damage there.
Because that sentence usually has nothing to do with them.
...
This is also why awareness of it is actually useful.
...
Over time, repeated misreads force a correction.
You stop leaning so heavily on what people say.  
...
That removes the false alignment.
It stops my own standards from doing all the interpretive work.
...
Not because my standards are wrong.
Because you applied them too broadly.
...
The problem starts when you assume they’re shared.
...
Projection and false consensus are quiet problems.
They make other people seem more aligned with you than they really are.
